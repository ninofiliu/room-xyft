const createShader = async (gl, type, url) => {
...
export const webglSetup = async (canvas, vertexUrl, fragmentUrl) => {
...
export const addTexture = (gl, nb, location) => {
...
export const setTextureImage = (gl, nb, source) => {
  gl.activeTexture(gl.TEXTURE0 + nb);
